          ...
          <div className="space-y-6">
            ...
            <Section title={t("preferredArea")}>
              <select value={settings.selectedArea} onChange={(e) => update("selectedArea", e.target.value)}
                ...
                <optgroup label={isAr ? "بيروت وجبل لبنان" : "Beirut & Mount Lebanon"}>
                  <option>بيروت</option><option>بعبدا</option><option>المتن</option><option>كسروان</option><option>جبيل</option><option>الشوف</option><option>عاليه</option>
                </optgroup>
                <optgroup label={isAr ? "الجنوب" : "South Lebanon"}>
                  <option>صور</option><option>صيدا</option><option>جزين</option><option>النبطية</option><option>بنت جبيل</option><option>مرجعيون</option><option>حاصبيا</option>
                </optgroup>
                <optgroup label={isAr ? "الشمال وعكار" : "North & Akkar"}>
                  <option>طرابلس</option><option>الكورة</option><option>زغرتا</option><option>بشري</option><option>البترون</option><option>المنية-الضنية</option><option>عكار</option>
                </optgroup>
                <optgroup label={isAr ? "البقاع وبعلبك-الهرمل" : "Bekaa & Baalbek-Hermel"}>
                  <option>بعلبك</option><option>الهرمل</option><option>زحلة</option><option>البقاع الغربي</option><option>راشيا</option>
                </optgroup>
              </select>
            </Section>
